...
int main() {
    try {
        ...
        writeCSV("c:\\Users\\marsh\\Patent Tracking\\Matched\\Matched_CUSIP.csv", matchedData);
        writeCSV("c:\\Users\\marsh\\Patent Tracking\\Matched\\UnMatched_CUSIP.csv", noMatchData);
...
//Compile with: g++ -o CUSIP_to_UniqueAssignee CUSIP_to_UniqueAssignee.cpp
//Run with: ./CUSIP_to_UniqueAssignee